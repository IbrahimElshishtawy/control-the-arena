...
class RiftZoneScene(Scene):
    def __init__(self, game):
        ...
        # Enemies (like corrupted echoes / patrols)
    ...
    def _spawn_enemies(self):
        ...
        # Enemies patrol horizontally around the center
    ...
    def update(self, dt):
        ...
        if self.player.is_alive():
            ...
            if hits:
                # Slightly lower damage than city (zone is already confusing)
    ...
    def draw(self, surface):
        ...
        # HUD + death overlay
        self._draw_hud(surface)# scenes/rift_zone.py
import pygame
import math
...
class RiftZoneScene(Scene):
    ...
    def _draw_hud(self, surface):
        ...
        if not self._both_echoes_synced():
            ...
            text = "Objective: Approach the Rift gate and anchor this branch with the Keepers."
